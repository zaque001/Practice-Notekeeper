...
public class DataManagerTest {
    ...
    public void createNewNote() {
        ...
        final String noteText="This the body text of test note";

        int noteIndex= sDataManager.createNewNote();
        NoteInfo newnNote= sDataManager.getNotes().get(noteIndex);
        newnNote.setCourse(course);
        newnNote.setTitle(noteTitle);
        newnNote.setText(noteText);
